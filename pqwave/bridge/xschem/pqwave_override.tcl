...
# 2. Send full path for table_set so pqwave can find the .raw file
...
proc setup_tcp_gaw {} {
  ...
  # First try args field (most reliable for port specification)
  ...
  # Send full path — pqwave needs the directory to find the file
  puts $gaw_fd "table_set $netlist_dir/$s.raw"
  return 1
}
