...
Back-annotation stamps trace values onto pqwave_label.sym ``value``
...
class XschemCrossProbeClient(QObject):
    ...
    def stamp_values(self, net_values: dict[str, str]) -> bool:
        ...
        Finds pqwave_label.sym instances whose ``lab`` attribute matches
    ...
    def _build_label_map(self) -> dict[str, str]:
        ...
        for i in range(0, len(tokens) - 2, 3):
            ...
            if sym_name in ("pqwave_label.sym",):
