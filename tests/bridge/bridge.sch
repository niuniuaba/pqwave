...
N 640 400 640 430 {lab=r1}
N 720 400 720 430 {lab=r1}
...
N 780 400 780 520 {lab=r1}
N 640 400 840 400 {lab=r1}
N 840 400 840 430 {lab=r1}
...
C {simulator_commands_shown.sym} 460 190 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false
value=".control
tran 1e-05 0.04 0
...
.endc
"}
C {lab_wire.sym} 840 400 0 0 {name=p2 sig_type=std_logic lab=r1}
